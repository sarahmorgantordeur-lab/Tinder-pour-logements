...
router.post('/:id/pictures', authenticate, isOwnerOrAgency, uploadPicturesMiddleware, ApartmentController.uploadPictures);
router.delete('/:id/pictures', authenticate, isOwnerOrAgency, ApartmentController.removePicture);
